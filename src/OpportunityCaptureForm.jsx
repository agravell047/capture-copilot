...
const DEMO_GO_FORM_DATA = {
  ...
  stakeholders: [
    {
      contactId: 'contact-erin-james',
      id: 'contact-erin-james',
      name: 'Erin James',
      ...
      nextTouch: '',
      notes: 'Active relationship as incumbent prime — attended our QBR in February and requested Phase II technical roadmap.',
    },
    {
      contactId: 'contact-michael-chen',
      id: 'contact-michael-chen',
      name: 'Michael Chen',
      role: 'Contracting Officer Representative – Technical Authority',
      office: 'VA OIT',
      relationshipStrength: 'strong',
      lastTouch: '2026-03-15',
      nextTouch: '',
      notes: 'Working relationship through Phase I delivery. COR has informally indicated satisfaction with performance.',
    },
    {
      contactId: 'contact-sandra-patel',
      id: 'contact-sandra-patel',
      name: 'Sandra Patel',
      role: 'Contracting Officer',
      office: 'VA Contracting Office',
      relationshipStrength: 'moderate',
      lastTouch: '2026-02-10',
      nextTouch: '',
      notes: 'CO on the Phase I task order. Familiar with Apex as incumbent prime.',
    },
  ],
  similarPursuits: ['pp-001-va-vba-modernization', 'pp-002-cms-platform'],
}
